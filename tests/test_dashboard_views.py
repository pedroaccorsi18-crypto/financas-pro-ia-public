...
class DashboardViewsTests(unittest.TestCase):
    ...
    def test_estado_inicial_orienta_primeiros_passos(self):
        ...
        self.assertIn("Saldo, receitas e despesas", texto_renderizado)
        self.assertIn("Categorias e limites", texto_renderizado)
        self.assertIn("Primeiro diagnóstico", texto_renderizado)
